...
var parameters = {
                    serveraddress: '101.99.1.1:5060', // your VoIP server IP address, domain name or SRV DNS record (also set the :port if that is not the default 5060)
                    username: '102', // preconfigured SIP account username
                    password: 'FWmxP7VVkwaU8P7d', // preconfigured SIP account password                    
					//other parameters are optional. See the documentation for the complete parameter list of available settings.
                    webrtcserveraddress: 'ws://101.99.1.1:8080/ws',
                    authuser: 'nXo9ftRi',
                    loglevel: 5
                 };
